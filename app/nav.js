...
const langSwitch = `<style>.lang-switch button{border:0;background:transparent;color:inherit;font-family:inherit;font-weight:600;font-size:12px;line-height:1;padding:5px 10px;border-radius:999px;cursor:pointer;}.lang-switch button[aria-pressed="true"]{background:#FF5500;color:#fff;}</style><script>function pirabelSetLang(l){var p=location.pathname;if(l==="en"){var h=location.host.replace(/-/g,"--").replace(/\\./g,"-");location.href="https://"+h+".translate.goog"+p+"?_x_tr_sl=fr&_x_tr_tl=en&_x_tr_hl=en";}else{location.href="https://www.pirabellabs.com"+p;}}(function(){var b=document.querySelector('.lang-switch button[data-l="fr"]');if(b)b.setAttribute("aria-pressed","true");})();</script>`;
